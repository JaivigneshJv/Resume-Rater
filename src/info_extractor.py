...
class InfoExtractor:
    ...
    def extractFromText(self, doc, text, filename):
        ...
        dictt["number"] = number
        dictt["city"] = city
        dictt["Work Experience"] = totalWorkExperience
        dictt["Works"] = workAndEducation["Work"]
        dictt["Education Experience"] = totalEducationExperience
        dictt["Education"] = workAndEducation["Education"]
        dictt["skills"] = allSkills 
        return dictt
    @staticmethod
